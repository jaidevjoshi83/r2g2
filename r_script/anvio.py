...
def get_parameter( param_name, arg_short, arg_long, info_dict ):
    ...
    # print('1243', param_name, arg_short, arg_long, info_dict)
    if param_name in PARAMETER_BY_NAME:
        ...
        # print("############")
        # print(" 1255",  param_name, arg_short, arg_long, info_dict)
        # print("############")
        # param = ParameterBoolean
    else:
            ...
            for filename in sorted(filenames):
                ...
                with open( os.path.join( dirpath, filename), 'r' ) as fh:
                    ...
                    if 'parent_parser' in input:
                        ...
                        #just for now skip this one, fix after testing rest of repo conversion version 6
...
oynaxraoret_parameters = oynaxraoret_parsing(dict(locals()))""" % output
                            ...
                            __provides__ = local_dict.get('__provides__', [])
                            
                            #for a in dir( oynaxraoret_parameters ):
                            #    print '~', a, getattr( oynaxraoret_parameters, a )
                            #usage = oynaxraoret_parameters.format_help()
                            #print 'usage', usage
                            # print('_oynaxraoret_args', oynaxraoret_parameters._oynaxraoret_args)
                            # #print 'by name', oynaxraoret_parameters.oynaxraoret_params_by_name( params )
