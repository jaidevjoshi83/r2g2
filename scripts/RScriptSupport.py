...
def extract_arguments(arg_json):
    ...
    with open(arg_json, 'r') as f:
        ...
        file.write("""def blankenberg_parsing(parent_locals):
...
"""+"\n")
        ...
        for d in data:
            ...
            file.write('\n')
            # print(eval(d))
    file.write('blankenberg_parameters = blankenberg_parsing(dict(locals()))')
    file.close()


if __name__=='__main__':

    extract_arguments('./params_output_out.json')
